...
model = load_model('./alzheimer_model_v1.keras')
...
for image_temp in image_files[0]:
    images_loaded.append(image.load_img('./images/nonDement/' + image_temp, target_size=(176, 208)))

for image_temp in image_files[1]:
    images_loaded.append(image.load_img('./images/withDement/' + image_temp, target_size=(176, 208)))
